...
const electronRuntimeConfig =
  typeof window !== "undefined" && window?.electronAPI?.config
    ? window.electronAPI.config
    : {};

export const BRAND_NAME = "WAAN";
export const RELAY_SERVICE_NAME = "WAAN Relay";
export const RELAY_CLIENT_LABEL = "WAAN Relay";
export const ISSUE_REPORT_BASE_URL = "https://github.com/suyashkmr/WAAN/issues/new";

export const API_BASE =
  runtimeConfig.apiBase
  || electronRuntimeConfig.apiBase
  || "http://127.0.0.1:3334/api";
export const RELAY_BASE =
  runtimeConfig.relayBase
  || electronRuntimeConfig.relayBase
  || "http://127.0.0.1:4546";
